function [x,error,fval,constraints_violate] = PG_EXTRA(mixing_matrix,lambda,x0,A,b,n,d,x_opt,f_opt,maxiter)
    ...
    for kk = 1:maxiter-1
        ...
        vec = kron(mixing_matrix, eye(d)) * x(:,kk) - alpha * AA'*(AA*x(:,kk) - bb) - w(:,kk);
